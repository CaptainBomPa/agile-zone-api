...
VALUES ('2023-12-23T00:00:01', '2024-01-06T00:00:00'),
...
VALUES ('admin', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 1,
        '{ADMINISTRATOR, PROJECT_SUPERVISOR, EDITING}', 'Jan',
        'Kowalski',
        1, true),
       ('user', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 1, '{EDITING}', 'Adam', 'Nowak', 1,
        true),
       ('user1', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 1, '{}', 'Krzysztof',
        'Nowak',
        1, true),
       ('user2', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 1, '{EDITING}', 'John', 'Smith', 1,
        true),
       ('user3', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 2, '{EDITING}', 'Michael',
        'Anderson',
        1, true),
       ('user4', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 2, '{EDITING}', 'Christopher',
        'Martinez', 1, true),
       ('user5', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 2, '{EDITING}', 'Sophia', 'Brown',
        1,
        true),
       ('user6', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 2, '{EDITING}', 'Jennifer',
        'Miller',
        1, true),
       ('user7', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 3, '{EDITING}', 'Benjamin', 'Hall',
        1, true),
       ('user8', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 3, '{EDITING}', 'Emma', 'Clark', 1,
        true),
       ('user9', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 3, '{EDITING}', 'Joshua', 'Walker',
        1, true),
       ('user10', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', 3, '{EDITING}', 'Jacob', 'Turner',
        1, true),
       ('user11', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', null, '{}', 'Jan', 'Kowalski',
        null, false),
       ('user12', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', null, '{}', 'Mariusz', 'Kowalczyk',
        null, false),
       ('user13', '$2a$10$UnXXPyrBAXsxB.nmqlmjZeWUgoTXmNBZqytQw.wzl6vVdgemXvB7e', null, '{}', 'John', 'Johnson',
        null, false);
