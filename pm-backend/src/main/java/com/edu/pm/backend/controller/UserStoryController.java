...
public class UserStoryController {
    ...
    @DeleteMapping(value = "/userStory/{id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @PutMapping(value = "/userStory/multiple", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @PostMapping(value = "/userStory", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
